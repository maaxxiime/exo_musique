let content = document.getElementById("content_hifi");
...
img_un.src = hifi.produits[0].imgurl;
name_un.textContent = hifi.produits[0].nom;
ref_un.textContent = hifi.produits[0].référence;
price_un.textContent = hifi.produits[0].prix;

img_deux.src = hifi.produits[1].imgurl;
name_deux.textContent = hifi.produits[1].nom;
ref_deux.textContent = hifi.produits[1].référence;
price_deux.textContent = hifi.produits[1].prix;

img_trois.src = hifi.produits[2].imgurl;
name_trois.textContent = hifi.produits[2].nom;
ref_trois.textContent = hifi.produits[2].référence;
price_trois.textContent = hifi.produits[2].prix;
...
img_quatre.src = hifi.produits[3].imgurl;
name_quatre.textContent = hifi.produits[3].nom;
ref_quatre.textContent = hifi.produits[3].référence;
price_quatre.textContent = hifi.produits[3].prix;

img_cinq.src = hifi.produits[4].imgurl;
name_cinq.textContent = hifi.produits[4].nom;
ref_cinq.textContent = hifi.produits[4].référence;
price_cinq.textContent = hifi.produits[4].prix;

img_six.src = hifi.produits[5].imgurl;
name_six.textContent = hifi.produits[5].nom;
ref_six.textContent = hifi.produits[5].référence;
price_six.textContent = hifi.produits[5].prix;
...
img_sept.src = hifi.produits[6].imgurl;
